...
程序默认打开索引为 0 的摄像头，并实时显示经过灰度化、高斯模糊和 Canny 处理的边缘图。按 Q/q 或关闭画面窗口可以退出，按 S/s 可以将当前带有 FPS 信息的边缘图保存到 `frames/`。
...
- [2026-09-10：分离图像处理职责并验证灰度预览](ENGINEERING_LOG/2026-09-10-processor.md)
- [2026-09-10：实现并理解基础边缘检测流程](ENGINEERING_LOG/2026-09-10-edge.md)
